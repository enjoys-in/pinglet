 ...
 * Beautiful permission request dialog for browser push notifications.
 */
...
export function createNotificationPermissionDialog(options = {}) {
	...
	dialog.className = "pinglet-permission-dialog";
	Object.assign(dialog.style, {
		...
		animation: "pinglet-slideIn 0.6s ease-out 1s forwards",
		fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",
	});

	// Inject animation
	if (!document.getElementById("pinglet-permission-anim")) {
		const style = document.createElement("style");
		style.id = "pinglet-permission-anim";
		style.textContent = `
@keyframes pinglet-slideIn { to { transform: translateX(0); } }
@keyframes pinglet-pulse {
  0%, 100% { box-shadow: 0 4px 12px rgba(102, 126, 234, 0.3); }
  50% { box-shadow: 0 4px 20px rgba(102, 126, 234, 0.5); }
}
@media (max-width: 480px) {
  .pinglet-permission-dialog {
    width: calc(100vw - 32px) !important;
    right: 16px !important;
    bottom: 16px !important;
    transform: translateY(420px) !important;
  }
  @keyframes pinglet-slideIn { to { transform: translateY(0); } }
}`;
	...
	closeBtn.innerHTML = '<svg viewBox="0 0 16 16" fill="currentColor" width="12" height="12"><path d="M12.854 4.854a.5.5 0 0 0-.708-.708L8 8.293 3.854 4.146a.5.5 0 1 0-.708.708L7.293 9l-4.147 4.146a.5.5 0 0 0 .708.708L8 9.707l4.146 4.147a.5.5 0 0 0 .708-.708L8.707 9l4.147-4.146z"/></svg>';
	...
	Object.assign(iconBubble.style, {
		width: "48px",
		height: "48px",
		borderRadius: "12px",
		marginBottom: "16px",
		animation: "pinglet-pulse 2s infinite",
		background: "linear-gradient(135deg, #667eea 0%, #764ba2 100%)",
		display: "flex",
		alignItems: "center",
		justifyContent: "center",
	});
	iconBubble.innerHTML = '<svg viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" width="24" height="24"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/></svg>';
