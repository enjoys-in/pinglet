...
let e = function () {
	return (
		(e =
			Object.assign ||
			((e) => {
				for (let n, t = 1, r = arguments.length; t < r; t++)
...
function r(e, n, t) {
	if (t || 2 === arguments.length)
		for (let r, o = 0, a = n.length; o < a; o++)
			(!r && o in n) ||
...
function h(e, n) {
	n = n || 0;
	let t;
	const r = (e = e || "").length % 16;
	const o = e.length - r;
	let a = [0, n];
	let i = [0, n];
	let c = [0, 0];
	let u = [0, 0];
	const h = [2277735313, 289559509];
...
function y(e, n) {
	return "number" === typeof e && Number.isNaN(e) ? n : e;
}
function g(e) {
			...
			const t = new Promise((t) => {
				...
				i(e.bind(null, n), () => {
					for (let e = [], n = 0; n < arguments.length; n++)
						e[n] = arguments[n];
					const o = Date.now() - r;
					if (!e[0]) return t(() => ({ error: L(e[1]), duration: o }));
					const a = e[1];
					if (k(a)) return t(() => ({ value: a, duration: o }));
					t(
						() =>
							new Promise((e) => {
								const n = Date.now();
								i(a, () => {
									for (let t = [], r = 0; r < arguments.length; r++)
										t[r] = arguments[r];
			...
			return n(this, void 0, void 0, function () {
				...
				return t(this, (t) => {
					switch (t.label) {
						...
						case 3:
							for (n = t.sent(), r = {}, o = 0; o < a.length; ++o)
								r[a[o]] = n[o];
							return [2, r];
					}
				});
...
const ne = {
		...
		X((e, n) => {
			...
			return J.filter(
				(e) => (
					(n = l[e]),
					I.some(
						(e, t) => n[t].offsetWidth !== a[e] || n[t].offsetHeight !== i[e],
					)
				),
			);
		}),
				...
				switch (t.label) {
					...
					case 1:
						return (
							...
							(a = n.filter((n) => {
								const t = e[n];
								return g(t.map((e) => o[e])) > 0.6 * t.length;
							})).sort(),
							[2, a]
						);
				}
	...
	fontPreferences: () =>
		((e, n) => {
			...
			for (let t = {}, r = {}, o = 0, a = Object.keys(ee); o < a.length; o++) {
				const i = a[o];
				const c = ee[i];
				const u = c[0];
				const l = void 0 === u ? {} : u;
				const s = c[1];
				const d = void 0 === s ? "mmMwWLliI0fiflO&1" : s;
			...
			for (let b = 0, y = Object.keys(ee); b < y.length; b++) {
	...
	audio: () => {
		const e = window;
		const n = e.OfflineAudioContext || e.webkitOfflineAudioContext;
		if (!n) return -2;
		if (
			x() &&
			!F() &&
		...
		const i = ((e) => {
			...
			return [
				new Promise((c, l) => {
					...
					let d = 0;
					let m = 0;
					e.oncomplete = (e) => c(e.renderedBuffer);
					const f = () => {
						setTimeout(() => l(R("timeout")), Math.min(r, m + o - Date.now()));
					};
					const v = () => {
						try {
		...
		const s = c.then(
			(e) =>
				((e) => {
					for (let n = 0, t = 0; t < e.length; ++t) n += Math.abs(e[t]);
					return n;
	...
	deviceMemory: () => y(b(navigator.deviceMemory), void 0),
	screenResolution: () => {
		const e = screen;
		const n = (e) => y(p(e), null);
		const t = [n(e.width), n(e.height)];
		return t.sort().reverse(), t;
	},
	hardwareConcurrency: () => y(p(navigator.hardwareConcurrency), void 0),
	timezone: () => {
		let e;
		const n =
	...
	invertedColors: () => !!_("inverted") || (!_("none") && void 0),
	forcedColors: () => !!O("active") || (!O("none") && void 0),
	monochrome: () => {
			...
			: U("high") || U("more")
				...
				: U("low") || U("less")
					...
					: U("forced")
						? 10
						: void 0,
	reducedMotion: () => !!Q("reduce") || (!Q("no-preference") && void 0),
	hdr: () => !!K("high") || (!K("standard") && void 0),
	math: () => {
		let e;
		const n = q.acos || $;
		const t = q.acosh || $;
...
function te(e) {
	...
	const t = ((e) => w(0.99 + 0.01 * e, 1e-4))(n);
	return {
		score: n,
...
function oe(e) {
	return h(
		((e) => {
			for (let n = "", t = 0, r = Object.keys(e).sort(); t < r.length; t++) {
				const o = r[t];
				const a = e[o];
				const i = a.error ? "error" : JSON.stringify(a.value);
				n += ""
					.concat(n ? "|" : "")
...
function ae(e) {
	return (
		...
		((e, n) => {
			...
			return t
				? new Promise((e) => t.call(window, () => e(), { timeout: n }))
				: o(Math.min(e, n));
		})(e, 2 * e)
	);
}
