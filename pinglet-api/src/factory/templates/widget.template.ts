 ...
 */
export const DEFAULT_WIDGET_TEMPLATE = (
	wid: string,
	text: string,
	description: string,
	buttonText: string,
	link: string,
	imagePreview: string = DEFAULT_IMAGE,
) => {
	return `(function() {
      const widgetId = '${wid}';
