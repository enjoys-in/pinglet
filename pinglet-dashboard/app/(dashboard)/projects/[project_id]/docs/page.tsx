    ...
    "-1": {
        ...
        request: {
            ...
            body: {
                ...
                buttons: [{ text: "Dismiss", action: "close" }],
            },
        },
        response: {
            success: true,
                                                        ...
                                                        <div>
                                                            ...
                                                            <div className="ml-4 space-y-1">
                                                                <div><span className="text-gray-500">type:</span>
                                                                    ...
                                                                    <span className="text-gray-400 ml-2 italic">(icon | image | audio | video | logo)</span>
                                                                </div>
                                                                <div><span className="text-gray-500">src:</span>
                                                                    <span className="text-yellow-400">"🔥"</span>
                                                                    <span className="text-gray-400 ml-2 italic">(emoji/text/svg if icon, else must be valid URL)</span>
                                                                </div>
                                                            </div>
                                                        </div>
