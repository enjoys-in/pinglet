    ...
    return (
        <div>
            <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/50 to-indigo-100/50">
                ...
                {/* Header Section */}
                <ProjectHeader project={project} copyToClipboard={copyToClipboard} StatusBadge={StatusBadge} />
                ...
                <ProjectWebsiteInfoCard website={project.website} copyToClipboard={copyToClipboard} StatusBadge={StatusBadge} category={project.category} />
            </div>
