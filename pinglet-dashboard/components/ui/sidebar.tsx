  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "duration-300 fixed inset-y-0 z-10 hidden h-svh w-[--sidebar-width] transition-[left,right,width] ease-in-out will-change-[width] md:flex",
            side === "left"
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      className={cn(
        "flex min-h-0 flex-1 flex-col gap-2 overflow-auto transition-[overflow] duration-300 group-data-[collapsible=icon]:overflow-hidden",
        className
      )}
      {...props}
    />
